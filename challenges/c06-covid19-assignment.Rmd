...
-   Which rows did you pick?
    ...
    -   Rows where `cases_per100k` and `deaths_per100k` are not missing (`NA`).
-   Why?
...
-   Comparison:
    ...
    -   The top counties for cases per 100k are approximately 20 times higher and the deaths per 100k are approximately 8 times higher.
...
-   Higher variability in small counties:
    ...
    -   This also suggests that small countries experience high fluctuations in case rates, likely due to their small populations and that people potentially got reinfected with COVID-19 multiple times. This data for small counties biases the overall data for cases per 100 k and deaths per 100k, and doesn't really indicate the trends for medium (50k-500k population) and large (\>500k population) counties.
