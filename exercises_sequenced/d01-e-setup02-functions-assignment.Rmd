...
The arguments for `rnorm` are: - n: no. of observations - mean: vector
of means - sd - vector of standard deviations

### **q4** Scroll to the bottom of the help for the `library()` function. How do you list all available packages?

We can list all packages using the command `library()` in the console.
